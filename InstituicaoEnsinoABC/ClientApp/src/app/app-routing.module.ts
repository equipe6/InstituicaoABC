...
const routes: Routes = [
    ...
    {path: 'pessoas', component: PessoasComponent, canActivate:[AppGuard] },
      {path: 'pessoa', component: PessoaComponent, canActivate: [AppGuard]},
      {path: 'pessoa/:id/:acao', component: PessoaComponent, canActivate: [AppGuard]},  
